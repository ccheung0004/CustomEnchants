...
import me.crunchycars.customEnchants.HemorrhageEnchantment;
...
public class HemorrhageEnchantmentCommand implements CommandExecutor {

    private final HemorrhageEnchantment enchantment;

    public HemorrhageEnchantmentCommand(HemorrhageEnchantment enchantment) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (meta != null) {
            ...
            meta.setLore(Arrays.asList(
                    ...
                    "§7Deals extra damage to opponents who are bleeding"
            ));
