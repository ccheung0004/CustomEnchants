...
import me.crunchycars.customEnchants.CripplingStrikeEnchantment;
...
public class CripplingStrikeEnchantmentCommand implements CommandExecutor {

    private final CripplingStrikeEnchantment enchantment;

    public CripplingStrikeEnchantmentCommand(CripplingStrikeEnchantment enchantment) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (meta != null) {
            ...
            meta.setLore(Arrays.asList(
                    ...
                    "§7Has a chance to inflict Slowness on the target"
            ));
