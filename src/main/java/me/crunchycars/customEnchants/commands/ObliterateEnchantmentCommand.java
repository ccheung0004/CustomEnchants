...
import me.crunchycars.customEnchants.ObliterateEnchantment;
...
public class ObliterateEnchantmentCommand implements CommandExecutor {

    private final ObliterateEnchantment enchantment;

    public ObliterateEnchantmentCommand(ObliterateEnchantment enchantment) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (meta != null) {
            ...
            meta.setLore(Arrays.asList(
                    ...
                    "§7Increases knockback dealt by your weapon"
            ));
