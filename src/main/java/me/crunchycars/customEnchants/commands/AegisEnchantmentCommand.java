...
import me.crunchycars.customEnchants.AegisEnchantment;
...
public class AegisEnchantmentCommand implements CommandExecutor {

    private final AegisEnchantment enchantment;

    public AegisEnchantmentCommand(AegisEnchantment enchantment) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (meta != null) {
            ...
            meta.setLore(Arrays.asList(
                    ...
                    "§7Reduces the effectiveness of offensive enchantments when hit"
            ));
