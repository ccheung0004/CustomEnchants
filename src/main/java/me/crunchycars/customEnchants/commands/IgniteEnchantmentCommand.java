...
import me.crunchycars.customEnchants.IgniteEnchantment;
...
public class IgniteEnchantmentCommand implements CommandExecutor {

    private final IgniteEnchantment enchantment;

    public IgniteEnchantmentCommand(IgniteEnchantment enchantment) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (!player.hasPermission("ignite.enchant")) {
        ...
        if (meta != null) {
            ...
            meta.setLore(Arrays.asList(
                    ...
                    "§7Has a chance to ignite enemies when hitting them."
            ));
