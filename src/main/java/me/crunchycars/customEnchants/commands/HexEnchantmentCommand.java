...
import me.crunchycars.customEnchants.HexEnchantment;
...
public class HexEnchantmentCommand implements CommandExecutor {

    private final HexEnchantment enchantment;

    public HexEnchantmentCommand(HexEnchantment enchantment) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (meta != null) {
            ...
            meta.setLore(Arrays.asList(
                    ...
                    "§7Has a chance to apply weakness to the target"
            ));
