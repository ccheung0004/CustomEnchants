...
import me.crunchycars.customEnchants.FrenzyEnchantment;
...
public class FrenzyEnchantmentCommand implements CommandExecutor {

    private final FrenzyEnchantment enchantment;

    public FrenzyEnchantmentCommand(FrenzyEnchantment enchantment) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (!player.hasPermission("frenzy.enchant")) {
        ...
        if (meta != null) {
            ...
            meta.setLore(Arrays.asList(
                    ...
                    "§7Increases your damage the more consecutive hits you land without being hit."
            ));
