...
import me.crunchycars.customEnchants.LeviathansBreathEnchantment;
...
public class LeviathansBreathEnchantmentCommand implements CommandExecutor {

    private final LeviathansBreathEnchantment enchantment;

    public LeviathansBreathEnchantmentCommand(LeviathansBreathEnchantment enchantment) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (meta != null) {
            ...
            meta.setLore(Arrays.asList(
                    ...
                    "§7Grants the Leviathan's Breath ability."
            ));
