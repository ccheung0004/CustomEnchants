...
import me.crunchycars.customEnchants.RiposteEnchantment;
...
public class RiposteEnchantmentCommand implements CommandExecutor {

    private final RiposteEnchantment enchantment;

    public RiposteEnchantmentCommand(RiposteEnchantment enchantment) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (!player.hasPermission("riposte.enchant")) {
        ...
        if (meta != null) {
            ...
            meta.setLore(Arrays.asList(
                    ...
                    "§7When you hit an enemy, block the next instance of damage you take."
            ));
