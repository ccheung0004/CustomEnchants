...
import me.crunchycars.customEnchants.ConfusionEnchantment;
...
public class ConfusionEnchantmentCommand implements CommandExecutor {

    private final ConfusionEnchantment enchantment;

    public ConfusionEnchantmentCommand(ConfusionEnchantment enchantment) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (!player.hasPermission("confusion.enchant")) {
        ...
        if (meta != null) {
            ...
            meta.setLore(Arrays.asList(
                    ...
                    "§7Has a chance to inflict confusion on your opponent."
            ));
