...
import me.crunchycars.customEnchants.ArsonistEnchantment;
...
public class ArsonistEnchantmentCommand implements CommandExecutor {

    private final ArsonistEnchantment enchantment;

    public ArsonistEnchantmentCommand(ArsonistEnchantment enchantment) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (!player.hasPermission("arsonist.enchant")) {
        ...
        if (meta != null) {
            ...
            meta.setLore(Arrays.asList(
                    ...
                    "§7Increases damage dealt while on fire."
            ));
