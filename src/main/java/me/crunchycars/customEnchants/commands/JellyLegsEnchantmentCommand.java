...
import me.crunchycars.customEnchants.JellyLegsEnchantment;
...
public class JellyLegsEnchantmentCommand implements CommandExecutor {

    private final JellyLegsEnchantment enchantment;

    public JellyLegsEnchantmentCommand(JellyLegsEnchantment enchantment) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (!player.hasPermission("jellylegs.enchant")) {
        ...
        if (meta != null) {
            ...
            meta.setLore(Arrays.asList(
                    ...
                    "§7Has a chance to negate fall damage."
            ));
