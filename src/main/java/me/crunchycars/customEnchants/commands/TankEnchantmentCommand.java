...
import me.crunchycars.customEnchants.TankEnchantment;
...
public class TankEnchantmentCommand implements CommandExecutor {

    private final TankEnchantment enchantment;

    public TankEnchantmentCommand(TankEnchantment enchantment) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (!player.hasPermission("tank.enchant")) {
        ...
        if (meta != null) {
            ...
            meta.setLore(Arrays.asList(
                    ...
                    "§7Reduces damage taken from axes."
            ));
