...
import me.crunchycars.customEnchants.SaturatedEnchantment;
...
public class SaturatedEnchantmentCommand implements CommandExecutor {

    private final SaturatedEnchantment enchantment;

    public SaturatedEnchantmentCommand(SaturatedEnchantment enchantment) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (!player.hasPermission("saturated.enchant")) {
        ...
        if (meta != null) {
            ...
            meta.setLore(Arrays.asList(
                    ...
                    "§7Increases saturation while wearing the helmet."
            ));
