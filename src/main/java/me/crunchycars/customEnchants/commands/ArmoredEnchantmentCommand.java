...
import me.crunchycars.customEnchants.ArmoredEnchantment;
...
public class ArmoredEnchantmentCommand implements CommandExecutor {

    private final ArmoredEnchantment enchantment;

    public ArmoredEnchantmentCommand(ArmoredEnchantment enchantment) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (!player.hasPermission("armored.enchant")) {
        ...
        if (meta != null) {
            ...
            meta.setLore(Arrays.asList(
                    ...
                    "§7Reduces damage taken from swords."
            ));
