...
import me.crunchycars.customEnchants.AssassinEnchantment;
...
public class AssassinEnchantmentCommand implements CommandExecutor {

    private final AssassinEnchantment enchantment;

    public AssassinEnchantmentCommand(AssassinEnchantment enchantment) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (!player.hasPermission("assassin.enchant")) {
        ...
        if (meta != null) {
            ...
            meta.setLore(Arrays.asList(
                    ...
                    "§7Increases damage dealt while sneaking."
            ));
