...
import me.crunchycars.customEnchants.VitalityEnchantment;
...
public class VitalityEnchantmentCommand implements CommandExecutor {
    ...
    private final VitalityEnchantment enchantment;

    public VitalityEnchantmentCommand(VitalityEnchantment enchantment) {
