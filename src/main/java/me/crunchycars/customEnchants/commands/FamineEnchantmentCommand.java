...
import me.crunchycars.customEnchants.FamineEnchantment;
...
public class FamineEnchantmentCommand implements CommandExecutor {

    private final FamineEnchantment enchantment;

    public FamineEnchantmentCommand(FamineEnchantment enchantment) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (meta != null) {
            ...
            meta.setLore(Arrays.asList(
                    ...
                    "§7Has a chance to drain hunger from the target"
            ));
