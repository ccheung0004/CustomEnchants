...
import me.crunchycars.customEnchants.SupermanEnchantment;
...
public class SupermanEnchantmentCommand implements CommandExecutor {

    private final SupermanEnchantment enchantment;

    public SupermanEnchantmentCommand(SupermanEnchantment enchantment) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (!player.hasPermission("superman.enchant")) {
        ...
        if (meta != null) {
            ...
            meta.setLore(Arrays.asList(
                    ...
                    "§7Grants Superman powers, launching you into the air and allowing you to glide.",
