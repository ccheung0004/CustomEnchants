...
import me.crunchycars.customEnchants.AxemanEnchantment;
...
public class AxemanEnchantmentCommand implements CommandExecutor {

    private final AxemanEnchantment enchantment;

    public AxemanEnchantmentCommand(AxemanEnchantment enchantment) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (meta != null) {
            ...
            meta.setLore(Arrays.asList(
                    ...
                    "§7Increases damage to players wielding swords"
            ));
