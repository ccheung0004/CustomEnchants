...
import me.crunchycars.customEnchants.LastStandEnchantment;
...
public class LastStandEnchantmentCommand implements CommandExecutor {

    private final LastStandEnchantment enchantment;

    public LastStandEnchantmentCommand(LastStandEnchantment enchantment) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (!player.hasPermission("laststand.enchant")) {
        ...
        // Create the enchantment book item
        ...
        if (meta != null) {
            ...
            meta.setLore(Arrays.asList(
                    ...
                    "§7Grants Last Stand effect at 1 HP."
            ));
