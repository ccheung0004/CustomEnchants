...
import me.crunchycars.customEnchants.EruditionEnchantment;
...
public class EruditionEnchantmentCommand implements CommandExecutor {

    private final EruditionEnchantment enchantment;

    public EruditionEnchantmentCommand(EruditionEnchantment enchantment) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (!player.hasPermission("erudition.enchant")) {
        ...
        if (meta != null) {
            ...
            meta.setLore(Arrays.asList(
                    ...
                    "§7Has a chance to heal when hit by an opponent."
            ));
