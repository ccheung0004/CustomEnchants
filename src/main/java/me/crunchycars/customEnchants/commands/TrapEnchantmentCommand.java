...
import me.crunchycars.customEnchants.TrapEnchantment;
...
public class TrapEnchantmentCommand implements CommandExecutor {

    private final TrapEnchantment enchantment;

    public TrapEnchantmentCommand(TrapEnchantment enchantment) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (meta != null) {
            ...
            meta.setLore(Arrays.asList(
                    ...
                    "§7Has a chance to freeze your target"
            ));
