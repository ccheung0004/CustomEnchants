...
import me.crunchycars.customEnchants.SpringsEnchantment;
...
public class SpringsEnchantmentCommand implements CommandExecutor {

    private final SpringsEnchantment enchantment;

    public SpringsEnchantmentCommand(SpringsEnchantment enchantment) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (meta != null) {
            ...
            meta.setLore(Arrays.asList(
                    ...
                    "§7Grants jump boost to the wearer."
            ));
