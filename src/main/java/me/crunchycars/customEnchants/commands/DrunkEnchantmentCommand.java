...
import me.crunchycars.customEnchants.DrunkEnchantment;
...
public class DrunkEnchantmentCommand implements CommandExecutor {

    private final DrunkEnchantment enchantment;

    public DrunkEnchantmentCommand(DrunkEnchantment enchantment) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (!player.hasPermission("drunk.enchant")) {
        ...
        // Check if the enchantment tier is valid
        ...
        if (meta != null) {
            ...
            meta.setLore(Arrays.asList(
                    ...
                    "§7Chance to give Strength and Confusion when hit."
            ));
