...
import me.crunchycars.customEnchants.BackstabEnchantment;
...
public class BackstabEnchantmentCommand implements CommandExecutor {

    private final BackstabEnchantment enchantment;

    public BackstabEnchantmentCommand(BackstabEnchantment enchantment) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (!player.hasPermission("backstab.enchant")) {
        ...
        if (meta != null) {
            ...
            meta.setLore(Arrays.asList(
                    ...
                    "§7Deals extra damage when hitting an enemy from behind."
            ));
